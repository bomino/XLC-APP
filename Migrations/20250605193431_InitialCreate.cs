    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShiftQualificationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShiftId = table.Column<int>(type: "int", nullable: false),
                    QualificationId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShiftQualifications", x => x.ShiftQualificationId);
                    table.ForeignKey(
                        name: "FK_ShiftQualifications_Qualifications_QualificationId",
                        column: x => x.QualificationId,
                        principalTable: "Qualifications",
                        principalColumn: "QualificationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShiftQualifications_Shifts_ShiftId",
                        column: x => x.ShiftId,
                        principalTable: "Shifts",
                        principalColumn: "ShiftId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Locations",
                columns: new[] { "LocationId", "Address", "City", "IsActive", "Name", "State", "ZipCode" },
                values: new object[,]
                {
                    { 1, "123 Main St", "Anytown", true, "Main Office", "ST", "12345" },
                    { 2, "456 Industrial Blvd", "Anytown", true, "Warehouse", "ST", "12346" }
                });

            migrationBuilder.InsertData(
                table: "Qualifications",
                columns: new[] { "QualificationId", "Description", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, "Basic employee training", true, "Basic Training" },
                    { 2, "Certified forklift operator", true, "Forklift Operator" },
                    { 3, "Safety training certification", true, "Safety Certified" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CreatedAt", "Email", "FirstName", "IsActive", "LastName", "PasswordHash", "Role", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2025, 6, 5, 19, 34, 28, 164, DateTimeKind.Utc).AddTicks(8901), "admin@example.com", "Admin", true, "User", "$2a$11$8ZpGGXeQcab7EXhYmBZZOeJ8QJ8VmMZqQQJ8QJ8VmMZqQQJ8QJ8Vm", "Admin", null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftQualifications_QualificationId",
                table: "ShiftQualifications",
                column: "QualificationId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftQualifications_ShiftId",
                table: "ShiftQualifications",
                column: "ShiftId");

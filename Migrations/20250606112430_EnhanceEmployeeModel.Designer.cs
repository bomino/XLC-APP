...
namespace EmployeeScheduling.API.Migrations
{
    ...
    [Migration("20250606112430_EnhanceEmployeeModel")]
    partial class EnhanceEmployeeModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EmployeeScheduling.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2025, 6, 6, 11, 24, 28, 637, DateTimeKind.Utc).AddTicks(6213),

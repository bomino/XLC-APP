...
namespace EmployeeScheduling.API.Migrations
{
    ...
    [Migration("20250607014504_ComprehensiveScheduleManagement")]
    partial class ComprehensiveScheduleManagement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EmployeeScheduling.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2025, 6, 7, 1, 45, 2, 810, DateTimeKind.Utc).AddTicks(6378),
